...
import {
    Card, CardHeader, CardBody, CardTitle, Table, Row, Col, Nav, NavItem, NavLink, TabContent, TabPane, Button, Carousel,
    CarouselItem,
    CarouselControl,
    CarouselIndicators,
} from "reactstrap";
...
export default class HarvestsPopupView extends React.Component {
    constructor(props) {
        super(props);
        if (props.userMode) {
